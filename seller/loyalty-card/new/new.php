<?php
    ...
    try {
        ...
        $loyaltyCard = LoyaltyCard::fromForm($validator);
        $loyaltyCard->insert($connection);
...
<html lang="en">
    <head>
        ...
        <title>Games And Go - Loyalty Card Created</title>
    ...
    <body>
        ...
        <div class="panel box">
            <h2>Loyalty Card Creation Succesful</h2>
            <a href="../../">Home</a>
        </div>
    </body>
</html>